...
c6 = {'name':"c6",'loc':(600,400),'centerx':500,'centery':400, 'color':YELLOW, 'dir':CWISE, 'angle':56,'radius':5, 'speed':0.001, 'mass':438500, 'velocity':[0,0]}
...
def CenterofMass(planetlist):
    ...
    for i in planetlist:
        totalMass += i['mass']
    for i in planetlist:
        centerOfMassX += i['mass']*(i['radius']*cos(i['angle'])+i['centerx'])
        centerOfMassY += i['mass']*(i['radius']*sin(i['angle'])+i['centery'])
